...
CREATE TABLE `schedule_item` (
  ...
  KEY `FK1lrayluwo1spunt07t4l7nmw3` (`study_group_id`),
  KEY `FK9umqpmwqflvbk2iu0xl4vl14i` (`teacher_id`),
  CONSTRAINT `FK1lrayluwo1spunt07t4l7nmw3` FOREIGN KEY (`study_group_id`) REFERENCES `study_group` (`id`),
...
INSERT INTO `schedule_item` VALUES (119,103,62,102,4,111),(123,104,63,101,4,112),(124,108,64,102,4,113),(125,108,65,102,4,113),(126,105,70,101,4,114),(127,105,72,101,4,114),(128,106,76,102,4,115),(129,109,77,102,4,116),(131,106,78,102,4,115),(132,107,82,98,4,117),(133,110,82,98,4,118),(134,107,83,100,4,117),(135,110,84,99,4,118);
