...
public class StudyGroupController {
    ...
    public String getEditor(@PathVariable("studyGroupId") Integer studyGroupId, Model model) {
        ...
        Boolean notBoundToAnyStudent = (studyGroupService.getNotBoundToAnyStudentById(studyGroupId) != null);
        model.addAttribute("inactive", notBoundToAnySchedule && notBoundToAnyStudent);
